...
function LoginController() {
    ...
    const verificarMesa = async (mesaId) => {
        try {
            ...
            const response = await axios.post("http://44.200.213.219:9091/api/v1/mesa/criteria", payload);
    ...
    const criarPedido = async (clienteId) => {
        try {
            ...
            const response = await axios.post("http://44.200.213.219:9091/api/v1/pedido", pedidoPayload);
    ...
    const buscarPedidoPorCliente = async (clienteId) => {
        try {
            ...
            const response = await axios.post("http://44.200.213.219:9091/api/v1/pedido/criteria", payload);
    ...
    const handleLogin = async () => {
        if (loginData.mesa && loginData.nomeCliente) {
            try {
                ...
                const clienteResponse = await axios.post("http://44.200.213.219:9091/api/v1/cliente", clientePayload);
