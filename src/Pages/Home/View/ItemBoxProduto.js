...
function ItemBoxProduto({ url, imagem, descricao, onClick, produto }) {
  const isPlaceholder = !produto || !produto.produto; // Verifica se é um placeholder
    ...
    >
      <div className="w-28 h-28 rounded-full flex items-center justify-center bg-gray-100 hover:bg-gray-200 transition-all">
        {imagem ? (
          <img
            src={imagem}
            alt={descricao || "Imagem do produto"}
